...
While the following rules could simply be considered to be multiplicative rules, they almost single-handedly define quaternions as a number system, and so are much more than simply multiplicative rules.
